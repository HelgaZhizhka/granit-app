...
(function() {
	...
	/*TweenMax animation example promo page
	var	$canvasMain 					= document.getElementById('canvas-main'),
			$gridIntro 						= document.querySelectorAll('.section_intro .grid span'),
	...
	tl
		...
		.to($sectionTextTitle, 1, {
			opacity: 1,
			ease: Power1.easeInOut
		})
		.to($sectionTextLine, 1, {
			scale: 1,
			ease: Power1.easeInOut
		})
		.to($buttonNavCircle, 1, {
